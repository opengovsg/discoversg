...
function App(props) {
  ...
  const balance = useContractReader(readContracts, "DiscoverSG", "balanceOf", [address]);
  console.log("🤗 balance:", balance);

  // 📟 Listen for broadcast events
  const transferEvents = useEventListener(readContracts, "DiscoverSG", "Transfer", localProvider, 1);
    ...
    const updateYourCollectibles = async () => {
      ...
      for (let tokenIndex = 0; tokenIndex < balance; tokenIndex++) {
        try {
          ...
          const tokenId = await readContracts.DiscoverSG.tokenOfOwnerByIndex(address, tokenIndex);
          console.log("tokenId", tokenId);
          const tokenURI = await readContracts.DiscoverSG.tokenURI(tokenId);
        ...
        <div>
          <Button
            onClick={() => {
              ...
              tx(writeContracts.DiscoverSG.mintItem(loadedAssets[a].id, { gasPrice }));
            }}
          >
            Mint
          </Button>
